  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Siswa List</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body siswalist">
...
<script type="text/javascript">
  ...
  function tambahSiswa(tingkat, idBidang, idProgram, idKelas) {
    $.ajax({
      url  : "ajax/getSiswa.php",
      type : "POST",
      data : {
        'tingkat' : tingkat,
        'bidang'  : idBidang,
  ...
  function setSiswa(mode, idSiswa, idKelas) {
    $.ajax({
      url  : "ajax/setKelas.php",
      type : "POST",
      data : {
        'mode'    : mode,
        'idSiswa' : idSiswa,
