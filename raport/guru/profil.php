<?php
    ...
    if (isset($_GET["status"]) == "execute"){
        ...
        if ($nip != ""){
            ...
            if ($total > 0){
                echo '<script>window.location.href = "./profil.php?error=nip";</script>';
            }
        }
        ...
        if ($email != ""){
            ...
            $total = mysqli_num_rows($check);
            if ($total > 0){
                echo '<script>window.location.href = "./profil.php?error=email";</script>';
            }
        }
        ...
        $query = mysqli_query($con, "UPDATE tb_guru set nip = $nip, namaGuru = '$fullName', email = '$email', jenisKelamin = $jenis, agama = $agama, noTelp = '$noTelp', tempatLahir = '$tempat', tglLahir = '$tglLahir', alamat = '$alamat', foto = '$imgProfile', updatedDate = '$updatedDate', updatedBy = '$id' WHERE idGuru = $id");
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="profil.php?status=execute" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-4">
