<?php
    ...
    if (isset($_GET["status"]) == "execute"){
        ...
        if ($nisn != ""){
            ...
            if ($total > 0){
                echo '<script>window.location.href = "./profil.php?error=nisn";</script>';
            }
        }
        ...
        if ($nis != ""){
            ...
            $total = mysqli_num_rows($check);
            if ($total > 0){
                echo '<script>window.location.href = "./profil.php?error=nis";</script>';
            }
        }
        ...
        $query = mysqli_query($con, "UPDATE tb_siswa set nisn = '$nisn', nis = '$nis', kelas = '$kelas', email = '$email', 
                                    ...
                                    agama = '$agama', noTelp = '$noTelp', alamat = '$alamat', foto = '$imgProfile', updatedBy = $id, 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center">
                                    <div class="imgShow">
                                        ...
                                        ?>
                                            <img class="img-responsive" src="../assets/img/upload/<?php echo $fetch["foto"] ?>" style="width: 100%" alt="...">
                                        <?php
                                            }
                                        ?>  
                                    </div>
